...
export default function Navbar() {
  const linkStyle = "block py-2 pr-4 pl-3 text-white rounded hover:bg-pantry-blue-400" +
    "md:ml-4 md:px-3 md:py-2 md:rounded-md md:text-sm md:font-medium md:hover:bg-pantry-blue-500"
  ...
  function toggleShowTabs() {
    ...
    return (
    <nav className="bg-pantry-blue-500 text-white p-4 flex flex-wrap justify-between items-center pr-10 overflow-visible flex-shrink-0">
      {/* Pantry Logo */}
      <a className="" href="/">
      ...
      <div className='flex-grow md:order-2 md:flex-grow-0'>
