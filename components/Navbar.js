      ...
      <div className='md:order-2'>
        {!user ? <a className="bg-gray-100 text-gray-700 rounded px-3 py-1 " href="/signin">Sign In</a> :
          <div className="flex flex-col float-left md: order-2">
            <button className="focus:outline-none w-8 h-8 rounded-full bg-gray-100 text-gray-700 font-semibold" onClick={toggleUserDropdown}>
        ...
        <button type="button" onClick={toggleShowTabs}
          class="inline-flex items-center p-1 ml-3 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none" aria-controls="mobile-menu-2" aria-expanded="false">
